...
var expectedTransactionResults = map[int32]string{
...
var expectedTransactionTypes = map[int32]string{
...
func TestGetTransactionResult(t *testing.T) {
	for code, expected := range expectedTransactionResults {
...
func TestTransactionTypes(t *testing.T) {
	for protoId, expected := range expectedTransactionTypes {
