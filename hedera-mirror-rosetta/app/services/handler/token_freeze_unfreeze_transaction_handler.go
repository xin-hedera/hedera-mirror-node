...
type tokenFreezeUnfreezeTransactionHandler struct {
...
func (t *tokenFreezeUnfreezeTransactionHandler) Construct(
...
func (t *tokenFreezeUnfreezeTransactionHandler) ParseConstructedTransaction(
...
func (t *tokenFreezeUnfreezeTransactionHandler) ParseExecutedTransaction() ([]*rTypes.Operation, *rTypes.Error) {
	panic("implement me")
}

func (t *tokenFreezeUnfreezeTransactionHandler) Preprocess(operations []*rTypes.Operation) (
	[]hedera.AccountID,
	*rTypes.Error,
) {
...
func (t *tokenFreezeUnfreezeTransactionHandler) GetOperationType() string {
	return t.operationType
}

func (t *tokenFreezeUnfreezeTransactionHandler) GetSdkTransactionType() string {
	return t.transactionType
}

func newTokenFreezeTransactionHandler(tokenRepo repositories.TokenRepository) typedTransactionHandler {
	transactionType := reflect.TypeOf(hedera.TokenFreezeTransaction{}).Name()
	return &tokenFreezeUnfreezeTransactionHandler{
...
func newTokenUnfreezeTransactionHandler(tokenRepo repositories.TokenRepository) typedTransactionHandler {
