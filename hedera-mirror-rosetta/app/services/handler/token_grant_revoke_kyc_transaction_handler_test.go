...
func TestTokenGrantRevokeKycTransactionHandlerSuite(t *testing.T) {
	suite.Run(t, new(tokenGrantRevokeKycTransactionHandlerSuite))
}

type tokenGrantRevokeKycTransactionHandlerSuite struct {
	suite.Suite
}

func (suite *tokenGrantRevokeKycTransactionHandlerSuite) TestNewTokenGrantKycTransactionHandler() {
	h := newTokenGrantKycTransactionHandler(&repository.MockTokenRepository{})
	assert.NotNil(suite.T(), h)
}

func (suite *tokenGrantRevokeKycTransactionHandlerSuite) TestNewTokenRevokeKycTransactionHandler() {
	h := newTokenRevokeKycTransactionHandler(&repository.MockTokenRepository{})
	assert.NotNil(suite.T(), h)
}

func (suite *tokenGrantRevokeKycTransactionHandlerSuite) TestGetOperationType() {
	var tests = []struct {
		name       string
		...
		{
			name:       "TokenGrantKycTransactionHandler",
			newHandler: newTokenGrantKycTransactionHandler,
			expected:   config.OperationTypeTokenGrantKyc,
		},
		{
			name:       "TokenRevokeKycTransactionHandler",
			newHandler: newTokenRevokeKycTransactionHandler,
...
func (suite *tokenGrantRevokeKycTransactionHandlerSuite) TestGetSdkTransactionType() {
	var tests = []struct {
		name       string
		newHandler newHandlerFunc
		expected   string
...
func (suite *tokenGrantRevokeKycTransactionHandlerSuite) TestConstruct() {
	var tests = []struct {
		name             string
	...
	suite.T().Run("TokenGrantKycTransactionHandler", func(t *testing.T) {
		runTests(t, config.OperationTypeTokenGrantKyc, newTokenGrantKycTransactionHandler)
	})

	suite.T().Run("TokenDissociateTransactionHandler", func(t *testing.T) {
		runTests(t, config.OperationTypeTokenRevokeKyc, newTokenRevokeKycTransactionHandler)
	})
}

func (suite *tokenGrantRevokeKycTransactionHandlerSuite) TestParseConstructedTransaction() {
...
func (suite *tokenGrantRevokeKycTransactionHandlerSuite) TestParseExecutedTransaction() {
	assert.True(suite.T(), true)
}

func (suite *tokenGrantRevokeKycTransactionHandlerSuite) TestPreprocess() {
	var tests = []struct {
		name             string
		tokenRepoErr     *rTypes.Error
		updateOperations updateOperationsFunc
...
func (suite *tokenGrantRevokeKycTransactionHandlerSuite) getOperations(operationType string) []*rTypes.Operation {
