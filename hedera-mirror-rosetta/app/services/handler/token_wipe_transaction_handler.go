...
type tokenWipeTransactionHandler struct {
	tokenRepo       repositories.TokenRepository
	transactionType string
	validate        *validator.Validate
}

func (t *tokenWipeTransactionHandler) Construct(
...
func (t *tokenWipeTransactionHandler) ParseConstructedTransaction(
...
func (t *tokenWipeTransactionHandler) ParseExecutedTransaction() ([]*rTypes.Operation, *rTypes.Error) {
	panic("implement me")
}

func (t *tokenWipeTransactionHandler) Preprocess(operations []*rTypes.Operation) (
	[]hedera.AccountID,
	*rTypes.Error,
) {
...
func (t *tokenWipeTransactionHandler) GetOperationType() string {
	return config.OperationTypeTokenWipe
}

func (t *tokenWipeTransactionHandler) GetSdkTransactionType() string {
	return t.transactionType
}

func newTokenWipeTransactionHandler(tokenRepo repositories.TokenRepository) typedTransactionHandler {
