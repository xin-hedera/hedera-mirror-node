...
type tokenBurnTransactionHandler struct {
	operationType   string
	tokeRepo        repositories.TokenRepository
	transactionType string
}

func (t *tokenBurnTransactionHandler) Construct(
...
func (t *tokenBurnTransactionHandler) ParseConstructedTransaction(
...
func (t *tokenBurnTransactionHandler) ParseExecutedTransaction() ([]*rTypes.Operation, *rTypes.Error) {
	panic("implement me")
}

func (t *tokenBurnTransactionHandler) Preprocess(operations []*rTypes.Operation) (
	[]hedera.AccountID,
	*rTypes.Error,
) {
...
func (t *tokenBurnTransactionHandler) GetOperationType() string {
	return t.operationType
}

func (t *tokenBurnTransactionHandler) GetSdkTransactionType() string {
	return t.transactionType
}

func newTokenBurnTransactionHandler(tokenRepo repositories.TokenRepository) typedTransactionHandler {
...
func newTokenMintTransactionHandler(tokenRepo repositories.TokenRepository) typedTransactionHandler {
