...
type tokenAssociateTransactionHandler struct {
	operationType   string
	tokenRepo       repositories.TokenRepository
	transactionType string
}

func (t *tokenAssociateTransactionHandler) Construct(
...
func (t *tokenAssociateTransactionHandler) ParseConstructedTransaction(
...
func (t *tokenAssociateTransactionHandler) ParseExecutedTransaction() ([]*rTypes.Operation, *rTypes.Error) {
	panic("implement me")
}

func (t *tokenAssociateTransactionHandler) Preprocess(operations []*rTypes.Operation) (
	[]hedera.AccountID,
	*rTypes.Error,
) {
...
func (t *tokenAssociateTransactionHandler) GetOperationType() string {
	return t.operationType
}

func (t *tokenAssociateTransactionHandler) GetSdkTransactionType() string {
	return t.transactionType
}

func newTokenAssociateTransactionHandler(tokenRepo repositories.TokenRepository) typedTransactionHandler {
...
func newTokenDissociateTransactionHandler(tokenRepo repositories.TokenRepository) typedTransactionHandler {
