...
type tokenDeleteTransactionHandler struct {
	tokenRepo       repositories.TokenRepository
	transactionType string
}

func (t *tokenDeleteTransactionHandler) Construct(
...
func (t *tokenDeleteTransactionHandler) ParseConstructedTransaction(
...
func (t *tokenDeleteTransactionHandler) ParseExecutedTransaction() ([]*rTypes.Operation, *rTypes.Error) {
	panic("implement me")
}

func (t *tokenDeleteTransactionHandler) Preprocess(operations []*rTypes.Operation) (
	[]hedera.AccountID,
	*rTypes.Error,
) {
...
func (t *tokenDeleteTransactionHandler) GetOperationType() string {
	return config.OperationTypeTokenDelete
}

func (t *tokenDeleteTransactionHandler) GetSdkTransactionType() string {
	return t.transactionType
}

func newTokenDeleteTransactionHandler(tokenRepo repositories.TokenRepository) typedTransactionHandler {
