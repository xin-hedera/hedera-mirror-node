...
type tokenGrantRevokeKycTransactionHandler struct {
...
func (t *tokenGrantRevokeKycTransactionHandler) Construct(
...
func (t *tokenGrantRevokeKycTransactionHandler) ParseConstructedTransaction(
...
func (t *tokenGrantRevokeKycTransactionHandler) ParseExecutedTransaction() ([]*rTypes.Operation, *rTypes.Error) {
	panic("implement me")
}

func (t *tokenGrantRevokeKycTransactionHandler) Preprocess(operations []*rTypes.Operation) (
	[]hedera.AccountID,
	*rTypes.Error,
) {
...
func (t *tokenGrantRevokeKycTransactionHandler) GetOperationType() string {
	return t.operationType
}

func (t *tokenGrantRevokeKycTransactionHandler) GetSdkTransactionType() string {
	return t.transactionType
}

func newTokenGrantKycTransactionHandler(tokenRepo repositories.TokenRepository) typedTransactionHandler {
	transactionType := reflect.TypeOf(hedera.TokenGrantKycTransaction{}).Name()
	return &tokenGrantRevokeKycTransactionHandler{
...
func newTokenRevokeKycTransactionHandler(tokenRepo repositories.TokenRepository) typedTransactionHandler {
