...
| `hiero.mirror.test.acceptance.web3.simpleFees`                          | false                                        | Whether to enable simple fee logic for test assertions related to simple fees. This property can be deleted once simple fees are enablred in all environments. |
