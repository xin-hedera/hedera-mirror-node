...
| `hiero.mirror.test.acceptance.operatorBalance`                          | 76                                           | The amount of dollars to fund the operator. Applicable only when `createOperatorAccount` is `true`.                                                           |
...
| `hiero.mirror.test.acceptance.web3.opcode.tracer.enabled`               | true                                         | Whether to invoke the web3 opcode API.                                                                                                                        |
| `hiero.mirror.test.acceptance.web3.simpleFees`                          | true                                         | Whether to enable simple fee logic for test assertions related to simple fees. This property can be deleted once simple fees are enabled in all environments. |
